...
class HcmsUserManagementSystemApplicationTests {
	...
	public void init()
	{	
	   user1=new User("","Pragnapadma","Ravalibon@12",new BigInteger("9010330067"),"rava@gmail.com","user",21,"female","");   
	   user2=new User("","Varshini","Varshini@12",new BigInteger("9014727265"),"pranu@gmail.com","user",21,"female","");
	   user3=new User("","Ushasriepp","Ushasri@1",new BigInteger("9876543201"),"pragna@gmail.com","user",21,"female","");
	}
